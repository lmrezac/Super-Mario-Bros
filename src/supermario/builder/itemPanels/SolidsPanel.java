...
{
    private static final long serialVersionUID = -7849885564668790354L;
    ...
    @Override
    public void init() {
        (this.ground = new Button(this.frame, this.frame.game.textures.lightGround, null, null, "Solid platform found above ground.")).setItem(new Item(this.frame, 'l', "Ground", this.ground, -1, 2, 0, 0, true, true, 1));
       ...
       // (this.seaStone = new Button(this.frame, this.frame.game.textures.seaBlock, null, null, "Solid platform found as walls in water.")).setItem(new Item(this.frame, '§', "Sea Stone", this.seaStone, -1, 2, 0, 0, true, true, 1));
        ...
        (this.block = new Button(this.frame, this.frame.game.textures.lightBlock, null, null, "Solid platform found as walls above ground.")).setItem(new Item(this.frame, 'q', "Block", this.block, -1, 2, 0, 0, true, true, 1));
       ...
       // (this.stoneBlock = new Button(this.frame, this.frame.game.textures.stoneBlock, null, null, "Solid platform found as walls in castles.")).setItem(new Item(this.frame, '\u045e', "Stone Block", this.stoneBlock, -1, 2, 0, 0, true, true, 1));
        (this.metal = new Button(this.frame, this.frame.game.textures.lightMetal, null, null, "Solid metal platform found above ground.")).setItem(new Item(this.frame, 's', "Metal", this.metal, -1, 2, 0, 0, true, true, 1));
      ...
      //  (this.stoneMetal = new Button(this.frame, this.frame.game.textures.stoneMetal, null, null, "Solid metal platform found in castles.")).setItem(new Item(this.frame, 'u', "Stone Metal", this.stoneMetal, -1, 2, 0, 0, true, true, 1));
        ...
        (this.mushroomLeft = new Button(this.frame, this.frame.game.textures.mushroomLeft, null, "<html><center>Mushroom<br>Left</center></html>", "Solid platform that is the left side of a mushroom.")).setItem(new Item(this.frame, '\u25cb', "Mushroom Left", this.mushroomLeft, -1, 2, 0, 0, false, true, 1));
        (this.mushroomMiddle = new Button(this.frame, this.frame.game.textures.mushroomMiddle, null, "<html><center>Mushroom<br>Middle</center></html>", "Solid platform that is the middle of a mushroom.")).setItem(new Item(this.frame, '\u2642', "Mushroom Middle", this.mushroomMiddle, -1, 2, 0, 0, true, true, 1));
        (this.mushroomRight = new Button(this.frame, this.frame.game.textures.mushroomRight, null, "<html><center>Mushroom<br>Right</center></html>", "Solid platform that is the right side of a mushroom.")).setItem(new Item(this.frame, '\u25d9', "Mushroom Right", this.mushroomRight, -1, 2, 0, 0, false, true, 1));
        ...
        (this.mushroomStem = new Button(this.frame, this.frame.game.textures.mushroomStem, null, "<html><center>Mushroom<br>Bark</center></html>", "Permeable object that forms the stem of a mushroom top.")).setItem(new Item(this.frame, '\u2660', "Mushroom Stem", this.mushroomStem, -1, 2, 0, 0, true, false, 1));
    ...
    public void refreshIcons() {
        ...
        this.mushroomStem.setImages(textures.getLevelTypeAlt(levelType, textures.mushroomStem),null);
